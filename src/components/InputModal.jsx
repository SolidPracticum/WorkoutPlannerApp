...
function InputModal(props) {
  ...
  const addHandler = () => {
    if (ageD.trim().length === 0 || weightD.trim().length === 0 || heightD.trim().length === 0)
    ...
    <div className="bg">
      ...
      <div className="inputField">
        <div className="inputField_firstBlock">
          ...
          <span>{t("fourthModal.weight")}</span>
        </div>
      ...
      <div className="inputField">
        <div className="inputField_firstBlock">
          ...
          <span> {t("fourthModal.height")}</span>
        </div>
        <div>
          <input
            min="1"
